...
public class CcHub : IoNode<CcProtocMessage<chroniton, CcDiscoveryBatch>>
{
    ...
    public CcHub(CcCollective ccCollective, IoNodeAddress address,
        ...
        base(address, mallocNeighbor, prefetch, concurrencyLevel, ccCollective.MaxAdjuncts + 1) //TODO config
    {
    ...
    protected override ValueTask BlockOnListenerAsync<T, TContext>(
        Func<IoNeighbor<CcProtocMessage<chroniton, CcDiscoveryBatch>>, T, ValueTask<bool>> onHandshake = null,
