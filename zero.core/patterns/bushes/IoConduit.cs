...
namespace zero.core.patterns.bushes
{
        ...
        where TJob : IIoJob
    {
        ...
        public IoConduit(string description, IoSource<TJob> source, Func<object, IoSink<TJob>> mallocJob, int producers = 1, int consumers = 1) : base(description, source, mallocJob, false, true, producers: producers, consumers: consumers)
        {
