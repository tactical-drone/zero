...
public interface IIoNanite : IEquatable<IIoNanite>
{
    ...
    ///     ZeroAsync pattern
    /// </summary>
    ValueTask DisposeAsync(IIoNanite from, string reason, [CallerFilePath] string filePath = null,
    ...
    ValueTask<bool> ZeroAtomicAsync<T>(Func<IIoNanite, T, bool, ValueTask<bool>> ownershipAction, T userData = default,
