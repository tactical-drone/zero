...
public class IoZeroSemaphoreSlim : IoNanoprobe, IIoZeroSemaphoreBase<int>
{
        ...
        bool zeroAsyncMode = false) : base($"{nameof(IoZeroSemaphoreSlim)}: {description}", maxBlockers)
    {
        ...
        IIoZeroSemaphoreBase<int> newSem =
            new IoZeroCore<int>(description, maxBlockers, asyncTasks, initialCount, zeroAsyncMode);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool Release(int value, bool forceAsync = false, bool prime = true)
    {
