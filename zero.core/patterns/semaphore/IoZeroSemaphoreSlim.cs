...
namespace zero.core.patterns.semaphore
{
    ...
    {
        public IoZeroSemaphoreSlim(CancellationTokenSource asyncTasks, string description = "", int maxCount = 1, int initialCount = 0, int expectedNrOfWaiters = 1,
            bool enableAutoScale = false, uint zeroVersion = 1, bool enableFairQ = false, bool enableDeadlockDetection = false)
        {
            _semaphore = new IoZeroSemaphore(description, maxCount, initialCount, enableAutoScale, zeroVersion, enableFairQ, enableDeadlockDetection);
