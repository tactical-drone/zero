...
public struct IoManualResetValueStructTaskSource<T> : IValueTaskSource<T>, IValueTaskSource
{
    ...
    public IoManualResetValueStructTaskSource(bool runContinuationsAsynchronously = false,
        bool runContinuationsNatively = true)
    {
        IIoManualResetValueTaskSourceCore<T> coreRef = new IoManualResetValueTaskSourceCore<T>
        {
    ...
    public bool RunContinuationsAsynchronously
    {
        ...
        set => _coreRef.RunContinuationsAsynchronously = value;
    }
    ...
    {
        return _coreRef.IsBlocking(reset);
    }
}