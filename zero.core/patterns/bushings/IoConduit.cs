    ...
    where TJob : IIoJob
{
    ...
    public IoConduit(string description, IIoSource upstream, IoSource<TJob> source,
        Func<object, IIoNanite, IoSink<TJob>> mallocJob) : base(description, source, mallocJob, false, false)
    {
