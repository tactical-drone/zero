...
public class IoStateTransition<TState> : IoQueue<int>.IoZNode, IIoHeapItem
    where TState : struct, Enum
{
    ...
    /// <summary>
    ///     The absolute time it took to mechanically transition from the previous state to this state.
    ///     <see cref="EnterTime" /> - <see cref="IoQueue{T}.IoZNode.Prev" />. <see cref="EnterTime" />
    /// </summary>
