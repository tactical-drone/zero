...
public abstract class IoNetSocket : IoSocket
{
    ...
    protected IoNetSocket(SocketType socketType, ProtocolType protocolType, int concurrencyLevel) : base(socketType,
        protocolType, concurrencyLevel)
    {
    }
    ...
    /// </summary>
    [IoParameter] private readonly bool parm_enable_tcp_keep_alive = false;
    ...
    {
        if (NativeSocket.IsBound || NativeSocket.Connected) return;
