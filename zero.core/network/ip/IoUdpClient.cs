...

{
    ...
    public IoUdpClient(string description, int readAheadBufferSize, int concurrencyLevel) : base(description,
        readAheadBufferSize, concurrencyLevel)
    {
    }
    ...
    /// <param name="concurrencyLevel">Level of concurrency</param>
    public IoUdpClient(string description, IoNetSocket ioSocket, int prefetch, int concurrencyLevel) : base(description,
        ioSocket, prefetch, concurrencyLevel, false)
    {
    }
    ...
    public IoUdpClient(string description, IoNetClient<TJob> clone, IPEndPoint newRemoteEp,
        IoSocket.Connection kind) : base(description,
        new IoUdpSocket(clone.IoNetSocket.NativeSocket, newRemoteEp, clone.PrefetchSize, kind, true),
        clone.PrefetchSize, clone.ZeroConcurrencyLevel, false, true)
    {
    }
