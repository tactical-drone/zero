...
public class IoHeapIoTest
{
    ...
    {
        var h = new IoHeapIo<TestHeapItem, IoHeapIoTest>("test heap", _capacity * _capacity,
            static (o, @this) => new TestHeapItem(@this._localVar, (int)o), context: this)
        {
            PopAction = (item, o) => { item.TestVar = (int)o; }
        };
    ...
    [Fact]
    private async Task ConstructionTestAsync()
    {
        ...
        {
            Constructor = (newHeapItem, context) => { newHeapItem.TestVar6 = (int)context; },
            PopAction = (poppedItem, context) => { poppedItem.TestVar7 = (int)context; }
        };
    ...
    [Fact]
    private async Task DestructionTestAsync()
    {
        var capacity = 16;
    ...
    private readonly int _localVar = 2;
...
public class TestHeapItem : IoNanoprobe, IIoHeapItem
{
    ...
    public TestHeapItem(int testVar2, int testVar3)
    {
        TestVar2 = testVar2;
        TestVar3 = testVar3;
    }
