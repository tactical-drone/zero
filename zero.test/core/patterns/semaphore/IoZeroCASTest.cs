...
public class IoZeroCasTest
{
    ...
    private readonly ConcurrentBag<long> _selection = [];
    ...
    private async Task NextAsync()
    {
        ...
        _output.WriteLine(
            $"Bad = {bad}/{_count}, {(double)bad / _count * 100:0.0}%, rejected = {_rejected}/{_accepted} = {(double)_rejected / _accepted * 100:0.0}%, duplicates = {duplicates}");
