...
namespace zero.interop.entangled.common.model.interop
{
    ...
    {
        public static unsafe IIoTransactionModelInterface Deserialize(sbyte[] flexTritBuffer, int buffOffset, Func<IoMarshalledTransaction, IIoTransactionModelInterface> transform)
        {
