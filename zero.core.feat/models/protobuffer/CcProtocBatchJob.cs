...
///     from <see cref="CcProtocMessage{TModel,TBatch}" />s processed by <see cref="CcAdjunct" />s from here:
///     <see cref="CcAdjunct.ProcessAsync()" />
...
///     <see cref="CcAdjunct" /> -> <see cref="CcProtocMessage{TModel,TBatch}" />     -> <see cref="CcProtocBatchSource" />
///     -> <see cref="IoConduit{TJob}" />
///     <see cref="BlockingCollection{T}" /> -                 instead of this we use
///     <see cref="IoConduit{TJob}" />
///     <see cref="CcAdjunct" /> <- <see cref="CcProtocBatchJobJob{TModel,TBatch}" /> <-
///     <see cref="CcProtocBatchSource{TModel,TBatch}" /> <- <see cref="IoConduit{TJob}" />
/// </summary>
